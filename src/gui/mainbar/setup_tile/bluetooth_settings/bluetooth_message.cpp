...
LV_IMG_DECLARE(message_96px);
    ...
    src_icon_t src_icon[] = {
        ...
        { "snow", &owm13d_64px, &owm13d_64px },
        { "light snow", &owm13d_64px, &owm13d_64px },
        { "heavy snow", &owm13d_64px, &owm13d_64px },
        { "sleet", &owm13d_64px, &owm13d_64px },
        { "light shower sleet", &owm13d_64px, &owm13d_64px },
        { "shower sleet", &owm13d_64px, &owm13d_64px },
        { "light rain and snow", &owm13d_64px, &owm13d_64px },
        { "rain and snow", &owm13d_64px, &owm13d_64px },
        { "light shower snow", &owm13d_64px, &owm13d_64px },
        { "shower snow", &owm13d_64px, &owm13d_64px },
        { "heavy shower snow", &owm13d_64px, &owm13d_64px },
        { "freezing rain", &owm13d_64px, &owm13d_64px },
        { "mist", &owm50d_64px, &owm50d_64px },
        { "smoke", &owm50d_64px, &owm50d_64px },
        { "haze", &owm50d_64px, &owm50d_64px },
        { "sand/ dust whirls", &owm50d_64px, &owm50d_64px },
        { "fog", &owm50d_64px, &owm50d_64px },
        { "sand", &owm50d_64px, &owm50d_64px },
        { "dust", &owm50d_64px, &owm50d_64px },
        { "volcanic ash", &owm50d_64px, &owm50d_64px },
        { "squalls", &owm50d_64px, &owm50d_64px },
        { "tornado", &owm50d_64px, &owm50d_64px },
        { "", NULL }
    };
    ...
    if ( error ) {
        ...
        if( !strcmp( doc["t"], "notify" ) || !strcmp( doc["t"], "weather" ) ) {
            ...
            if ( doc["src"] ) {
                ...
                lv_img_set_src( bluetooth_message_img, bluetooth_message_find_img( doc["txt"] ) ); 
            ...
            if ( doc["body"] ) {
                ...
                weather_widget = widget_register( "weather", bluetooth_message_find_img( doc["txt"]), NULL);
                }
                /*
